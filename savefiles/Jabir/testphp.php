...
<h1>INET 4031 Database Query</h1>
<p>All Employees with last name Bade</p>

<?php

//this is the php object oriented style of creating a mysql connection
$conn = new mysqli('localhost', 'jadh', 'Maher123456*', 'employees' );
...
$sql = "SELECT first_name,last_name,hire_date  FROM employees where last_name = 'Bade'";
